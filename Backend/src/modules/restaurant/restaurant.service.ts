 ...
 */
const getRestaurantById = async (providerId: string) => {
 ...
 */
const getRestaurantMeals = async (providerId: string) => {
  if (!providerId) {
    throw new Error("Provider ID is missing");
  }
 ...
 */
const getRestaurantReviews = async (providerId: string) => {
  if (!providerId) {
    throw new Error("Provider ID is missing");
  }
 ...
 */
const getRestaurantStats = async (providerId: string) => {
  if (!providerId) {
    throw new Error("Provider ID is missing");
  }
