...
const getCustomerOrders = async (customerId) => {
    ...
    try {
        ...
        const ordersWithFilteredReviews = await Promise.all(orders.map(async (order) => {
 ...
 */
const updateOrderReview = async (reviewId, data) => {
    if (!reviewId) {
 ...
 * Delete a review
 */
const deleteOrderReview = async (reviewId) => {
    if (!reviewId) {
        throw new Error("Review ID is missing");
    }
    try {
