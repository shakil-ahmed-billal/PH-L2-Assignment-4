...
const getOrderById = async (req, res) => {
    ...
    try {
        const order = await reviewService.getOrderById(orderId);
        if (!order) {
...
const createOrder = async (req, res) => {
    ...
    try {
        const order = await reviewService.createOrder(orderData);
        res.status(201).send({
            success: true,
...
const updateOrderStatus = async (req, res) => {
    ...
    try {
        const updatedOrder = await reviewService.updateOrderStatus(orderId, status);
        res.status(200).send({
            success: true,
...
const getProviderOrders = async (req, res) => {
    ...
    try {
        const orders = await reviewService.getProviderOrders(providerId);
        res.status(200).send({
            success: true,
