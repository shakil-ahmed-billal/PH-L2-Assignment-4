...
const getProviderStats = async (req, res) => {
    try {
        ...
        const meals = await providerService.getProviderStats(providerId);
        res.status(200).json({
            success: true,
 ...
 */
const getOrderByProviderId = async (req, res) => {
    try {
        const providerId = req.params.id;
        const orders = await providerService.getOrderByProviderId(providerId);
        res.status(200).json({
            success: true,
...
const updateProviderProfile = async (req, res) => {
    try {
        ...
        const profile = await providerService.updateProviderProfile(providerId, profileData);
        res.status(200).json({
            success: true,
...
const getRevenueAnalytics = async (req, res) => {
    try {
        ...
        const analytics = await providerService.getRevenueAnalytics(providerId, new Date(startDate), new Date(endDate));
        res.status(200).json({
            success: true,
 ...
 */
const getTopSellingMeals = async (req, res) => {
    try {
        const providerId = req.params.id;
        const limit = parseInt(req.query.limit) || 10;
        const topMeals = await providerService.getTopSellingMeals(providerId, limit);
        res.status(200).json({
            success: true,
...
const updateOrderStatus = async (req, res) => {
    try {
        ...
        const order = await providerService.updateOrderStatus(orderId, status);
        res.status(200).json({
            success: true,
...
const updateMeal = async (req, res) => {
    try {
        ...
        const mealData = req.body;
        const meal = await providerService.updateMeal(mealId, mealData);
        res.status(200).json({
            success: true,
